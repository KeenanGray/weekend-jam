...
public class DisplacementFeature : ScriptableRendererFeature
{
    ...
    public class PassSettings
    {
        ...
        [Range(0f,0.1f)] public float magnitude = .1f;
        
        // A variable that's specific to the use case of our pass.
        public Color overlay_color = new Color(1,1,1,1);

        //the displacement texture
        public Texture displacement_map;
    ...
    public override void Create()
    {
        ...
        pass = new DisplacementFeaturePass(passSettings);
    }
